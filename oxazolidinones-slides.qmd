...
::: aside
Note that tedizolid is a prodrug — phosphate ester cleaved by plasma phosphatases. Contezolid (MRX-I) is approved in China for ABSSSI; the pipeline is moving on TB indications.
:::
...
![](oxazolidinone-images/basic%20structure.png){fig-align="center" width="350"}
...
![](oxazolidinone-images/Linezolid.png){fig-align="center"}
...
![](oxazolidinone-images/Tedizolid.png){fig-align="center"}
...
::: aside
The hydroxymethyl group is the specific modification that defeats Cfr methylation of A2503. The tetrazole/pyridine contribute to overall MIC reduction but are not the cfr-defeating feature [@Rybak2015; @Locke2010].
:::
...
![](oxazolidinone-images/linezolid_MOA.png){fig-align="center" width="800"}

::: aside
Oxazolidinones block one of the earliest steps in protein synthesis. Chloramphenicol and lincomycin bind in overlapping sites — useful for explaining mechanistic competition observed in vitro [@Colca2003; @Moellering2003].
:::
...
# Spectrum of activity {background-color="#b20e10"}
...
# Resistance {background-color="#b20e10"}
...
![](oxazolidinone-images/linezolid_R.png){fig-align="center" width="800"}
...
![](oxazolidinone-images/resistance_mechanism2.png){fig-align="center" width="800"}
...
![](oxazolidinone-images/resistance_3.png){fig-align="center" width="800"}

<br>

::: aside
PhLOPSₐ is worth committing to memory. Tedizolid's hydroxymethyl side chain is what allows it to retain activity against many cfr-carrying strains — but combined with chromosomal mutations, tedizolid resistance does emerge [@Diaz2012; @Brenciani2022].**Ph**enicols- Chloramphenicol, **L**incosamides, Clindamycin**, O**xazolidinones- Linezolid, **P**leuromutilins- Tiamulin, **S** **S**treptogramin**A-** Pristinamycin
:::
...
![](oxazolidinone-images/mechanism_4.png){fig-align="center" width="800"}
...
# Pharmacology — linezolid {background-color="#b20e10"}
...
- Two **inactive carboxylic-acid metabolites** in feces
  - Linezolid undergoes non-CYP3A4 oxidative metabolism, mainly morpholine-ring oxidation/ring opening, producing inactive metabolites A and B. The enzymatic component appears to involve atypical CYP4F enzymes, especially CYP4F3B and CYP4F11, rather than conventional hepatic CYP450 metabolism
...
- Driver of efficacy: **f~T \> MIC~ ≈ 85%** and **AUC₀₋₂₄/MIC 80–120**
...
- Trough **C~min~ 2–7 mg/L** suggested for Gram-positive infection
- **C~min~ \<2 mg/L** proposed for *M. tuberculosis* (MICs lower)
- **C~min~ \>7.5–22.1 mg/L** → hematologic toxicity risk rises
...
# Pharmacology — tedizolid {background-color="#b20e10"}
...
# Clinical use {background-color="#b20e10"}
...
# Pipeline {background-color="#b20e10"}
...
# Take-home points {background-color="#b20e10"}
